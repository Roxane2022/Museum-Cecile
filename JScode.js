 ...
 */
const o21Map = await Objekt21.CreateO21Map("13 MD21VG/data/objekt21-data.json")
...
function create_SearchList_element() {
    // zunaechst pruefen wir ob unsere Ergebnisliste bereits existiert
...
function show_all_021_Items_ids() {

    // Für jedes Element im Visitor Guide
    for (const [o21id, o21] of VG21) {

        const o21_item_Id = document.createElement("div");
        o21_item_Id.setAttribute("id", o21.objektID);
        o21_item_Id.setAttribute("class", "col s3 m4");


        let Menu_html_Template =
            ' <ul class="sidenav" id="mobile-nav-menu">'
        '<li><a href=${createHTMLElements(o21, o21_html_element)}>${o21.objektID}</a></li></ul>'


        o21_item_Id.innerHTML = Menu_html_Template;
